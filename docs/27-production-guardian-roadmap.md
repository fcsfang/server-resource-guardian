...
| PG-P0-07 systemd/自身保护 | `IN_PROGRESS` | P0-03,P0-05,P0-06 | EXP-034/035：主机 114/114、VM 隔离 71/71、systemd verify 退出码 0、8 秒 observe smoke、有界存储 fail-closed；长跑/故障注入/P99 校准未完成 | 继续有界 soak、依赖故障 fixture、真实日志/磁盘边界验证和资源 P99 测量 |
