...
| PG-P0-07 systemd/自身保护 | `IN_PROGRESS` | P0-03,P0-05,P0-06 | EXP-034/035/036/037/038/040：主机 116/116、VM 隔离 73/73、systemd verify 退出码 0、8 秒 smoke、有界存储 fail-closed、45 秒/5 分钟局部 soak、依赖 fixture、transient systemd readiness；EXP-039 24h soak 运行中，真实 watchdog 故障注入/P99 未完成 | 检查 EXP-039 结束结果，继续 watchdog/日志边界验证和资源 P99 测量 |
