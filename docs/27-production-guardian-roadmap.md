...
| PG-P0-07 systemd/自身保护 | `IN_PROGRESS` | P0-03,P0-05,P0-06 | EXP-034/035/036/037/038：主机 116/116、VM 隔离 73/73、systemd verify 退出码 0、8 秒 smoke、有界存储 fail-closed、45 秒/5 分钟局部 soak、依赖故障 fixture；24h/真实故障注入/P99 未完成 | 继续 24 小时级有界 soak、真实日志/磁盘边界验证和资源 P99 测量 |
