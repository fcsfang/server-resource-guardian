...
| PG-P0-07 systemd/自身保护 | `IN_PROGRESS` | P0-03,P0-05,P0-06 | EXP-034/035/036/037/038/040/041/043/044/045：主机 121/121、当前 VM 隔离回归 78/78、systemd verify 退出码 0、8 秒 smoke、有界存储 fail-closed、45 秒/5 分钟局部 soak、依赖 fixture、transient readiness/watchdog 通知接收、watchdog 余量契约、有限高压采样和自然失败重启；EXP-042 预检失败已保留；EXP-039 运行中约 4,564 秒、sidecar 441 样本/4,414 秒，RSS/CPU/FD/线程 P99 为 17,492 KiB/0.0%/5/1，RSS/FD 均值为 17,405.397 KiB/3.603，审计 1,046,557 bytes 且 Observer 存活；24h soak、watchdog 超时、SIGKILL/OOM 恢复、磁盘满边界和完整场景 P99 未完成 | 检查 EXP-039 结束结果，继续只读日志容量统计、剩余故障边界和资源 P99 测量 |
