...
- 2026-09-19 完成 EXP-024：只读 Adapter 增加重复、乱序、过期和传输失败的 fail-closed 处理，并覆盖 alerts_history 活动/恢复/缺少映射字段 fixture；宿主机 47/47、Multipass Ubuntu Adapter 测试 10/10，通过本地 Hub GET /api/health 200。见 experiments/EXP-024-2026-09-19-beszel-adapter-contract/record.md。
