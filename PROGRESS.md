...
提交并获得批准的 [x86_64 非生产验证申请包](docs/nonproduction-x86_64-validation-request.md)，确认主机、时间窗口、回滚负责人、真实通知渠道和收件人。获批后先做 x86_64 安装与只读观察，再单独申请一次可丢弃容器的温和停止验收。获批前不连接非生产或生产服务器。
