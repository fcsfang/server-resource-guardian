...
- 2026-09-20：运行中复核 EXP-039；sidecar 706 样本/7,071 秒，RSS P95/P99/最大值 17,752 KiB，审计 136/136 行合法 JSON 且事件 ID 无重复；`verification.json` 继续为 `RUNNING`，不改变 24 小时完成门。
